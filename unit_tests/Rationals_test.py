...
class TestRationals(unittest.TestCase):
    ...
    def test_MUL_QQ_Q(self):
        ...
        self.assertEqual(MUL_QQ_Q(RNumber('123/123'), RNumber('123/123')).__str__(), '1')
        self.assertEqual(MUL_QQ_Q(RNumber('246/123'), RNumber('123/123')).__str__(), '2')
        self.assertEqual(MUL_QQ_Q(RNumber('-246/123'), RNumber('123/123')).__str__(), '-2')
        self.assertEqual(MUL_QQ_Q(RNumber('-246/123'), RNumber('-123/123')).__str__(), '2')
        self.assertEqual(MUL_QQ_Q(RNumber('2'), RNumber('123/123')).__str__(), '2')
        self.assertEqual(MUL_QQ_Q(RNumber('3/2'), RNumber('2/3')).__str__(), '1')
        self.assertEqual(MUL_QQ_Q(RNumber('-3/2'), RNumber('2/3')).__str__(), '-1')
