...
import unittest
from ALEX import SUB_QQ_Q, MOD_ZZ_Z, MOD_PP_P
from Dtypes import Integer, Polynomial, RNumber
...
class test_rational(unittest.TestCase):
    ...
    def test_mod_PP_P(self):
        po_1 = Polynomial('12 24 -12')
        po_2 = Polynomial('6 0 1')
        print(MOD_PP_P(po_1,po_2))
