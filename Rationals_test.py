...
class TestRationals(unittest.TestCase):
    def test_RED_Q_Q(self):
        ...
        self.assertEqual(RED_Q_Q(RNumber('6726762439834275649822587948797802587/862536767676790869428574869848935876')).__str__(), '45582315319138840/5844776483523759')
        self.assertEqual(RED_Q_Q(RNumber('-987654321234567890/228')).__str__(), '82304526769547330/19')
    ...
    def test_ADD_QQ_Q(self):
        ...
        self.assertEqual(ADD_QQ_Q(RNumber('125558563222564588/224571828157826397658257'), RNumber('40987654/30987654')).__str__(), '4426290709422840/3346381010976827')
    ...
    def test_SUB_QQ_Q(self):
        ...
        self.assertEqual(
            ...
            '-5447957122673541/4120528591947753500')
    ...
    def test_MUL_QQ_Q(self):
        ...
        self.assertEqual(MUL_QQ_Q(RNumber('-1231312/124211'), RNumber('19876543/565')).__str__(), '-24474225914416/70179215')
