...
Ilist = ['ABS_Z_N', 'POZ_Z_D', 'MUL_ZM_Z', 'TRANS_N_Z', 'TRANS_Z_N', 'ADD_ZZ_Z', 'SUB_ZZ_Z', 'MUL_ZZ_Z', 'DIV_ZZ_Z',
         'MOD_ZZ_Z']
...
class TestIntegers(unittest.TestCase):
    ...
    def test_MUL_ZM_Z(self):
        ...
        self.assertEqual(MUL_ZM_Z(Integer('1')).__str__(), '-1')
        self.assertEqual(MUL_ZM_Z(Integer('-11111111111111111111111111111111')).__str__(),
    ...
    def test_DIV_ZZ_Z(self):
        ...
        a, b = '-123', '-9'
        self.assertEqual(DIV_ZZ_Z(Integer(a), Integer(b)).__str__(), '14')
        a, b = '123', '-9'
        self.assertEqual(DIV_ZZ_Z(Integer(a), Integer(b)).__str__(), '-13')
        a, b = '987' * 10, '-' + '123' * 10
        self.assertEqual(DIV_ZZ_Z(Integer(a), Integer(b)).__str__(), '-8')
    ...
    def test_MOD_ZZ_Z(self):
        ...
        self.assertEqual(MOD_ZZ_Z(Integer('-1'), Integer('-1')).__str__(), str(-1 % -1))
        a, b = '-123', '-9'
        self.assertEqual(MOD_ZZ_Z(Integer(a), Integer(b)).__str__(), '3')
        a, b = '123', '-9'
        ...
        a, b = '0', '-9'
        self.assertEqual(MOD_ZZ_Z(Integer(a), Integer(b)).__str__(), '0')
        a, b = '0', '0'
        self.assertRaises(ZeroDivisionError, MOD_ZZ_Z, Integer(a), Integer(b))
