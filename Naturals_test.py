...
class TestNaturals(unittest.TestCase):
    ...
    def test_MUL_NN_N(self):
        ...
        self.assertEqual(MUL_NN_N(NNumber('765431167180999993123'), NNumber('12312312312399999')).__str__(),
                         str(765431167180999993123 * 12312312312399999))
        self.assertEqual(MUL_NN_N(NNumber('7654765431167180999993123765431167180999993123'),
                                  NNumber('123765431167180999993123765431167180999993123')).__str__(),
                         str(7654765431167180999993123765431167180999993123 * 123765431167180999993123765431167180999993123))

    def test_SUB_NDN_N(self):
        self.assertEqual(SUB_NDN_N(NNumber('745386'), 9, NNumber('123')).__str__(), str(745386 - (9 * 123)))
        self.assertEqual(SUB_NDN_N(NNumber('74538683945791303426'), 9, NNumber('987654123')).__str__(),
                         str(74538683945791303426 - (9 * 987654123)))
        self.assertEqual(
            SUB_NDN_N(NNumber('7453868798798798792879348795487934'), 9, NNumber('126754673424873463')).__str__(),
            str(7453868798798798792879348795487934 - (9 * 126754673424873463)))
    ...
    def test_DIV_NN_N(self):
        ...
        self.assertEqual(DIV_NN_N(NNumber('123' * 12), NNumber('7' * 10)).__str__(),
                         str(int('123' * 12) // int('7' * 10)))
        ...
        self.assertEqual(
            DIV_NN_N(NNumber('12412159183579187985371097315155'), NNumber('1551515719586198375')).__str__(),
            str(12412159183579187985371097315155 // 1551515719586198375))
        self.assertRaises(ZeroDivisionError, DIV_NN_Dk, NNumber('0'), NNumber('0'))
        self.assertRaises(ZeroDivisionError, DIV_NN_Dk, NNumber('123123'), NNumber('0'))
    ...
    def test_MOD_NN_N(self):
        ...
        self.assertEqual(MOD_NN_N(NNumber('1248179861956178649586198'), NNumber('7529386519698146')).__str__(),
                         str(1248179861956178649586198 % 7529386519698146))
        self.assertEqual(MOD_NN_N(NNumber('10384758689746'), NNumber('73456743')).__str__(),
                         str(10384758689746 % 73456743))
    ...
    def test_GCF_NN_N(self):
        ...
        self.assertEqual(GCF_NN_N(NNumber('123123123123'), NNumber('99999999')).__str__(),
                         str(gcd(123123123123, 99999999)))
    ...
    def test_LCM_NN_N(self):
        ...
        self.assertEqual(LCM_NN_N(NNumber('1111111111111111111111'), NNumber('123')).__str__(),
                         str(lcm(1111111111111111111111, 123)))
